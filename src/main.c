...
UART1_frame_to_send_t u1_frame_send = {
    .buffer_to_send = "$RB_I,WA,20.623663,-100.405777,81,1.04,25,45#CS",
...
int main(void)
{
    ...
    rb_data.MESSAGE_SENT = RB_STATUS_INITIALIZING;
    rb_data.MESSAGE_RECEIVED = RB_STATUS_INITIALIZING;
...
// Receive message from GSS
        ...
        master_TM4.SendMaster(u1_frame_send.buffer_to_send, 47);
